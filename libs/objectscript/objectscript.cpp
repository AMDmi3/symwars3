...
template <> long double OS_getMaxValue<long double>()
{
    return LDBL_MAX;
}
template <> double OS_getMaxValue<double>()
{
    return DBL_MAX;
}
template <> float OS_getMaxValue<float>()
{
    return FLT_MAX;
}
template <> int OS_getMaxValue<int>()
{
    return INT_MAX;
}
...
{
    static const OS_CHAR * roundFmt()
    {
        return OS_TEXT("%.f");
    }
    static const OS_CHAR * precisionFmt()
    {
        return OS_TEXT("%.*f");
    }
    static const OS_CHAR * autoFmt()
    {
        return OS_TEXT("%.*G");
    }
};
...
const OS_CHAR * OS::Core::Tokenizer::getTokenTypeName(TokenType token_type)
{
    ...
    {
    case NOTHING:
        return OS_TEXT("NOTHING");

    case BEGIN_CODE_BLOCK:
        return OS_TEXT("BEGIN_CODE_BLOCK");
    case END_CODE_BLOCK:
        return OS_TEXT("END_CODE_BLOCK");

    case BEGIN_BRACKET_BLOCK:
        return OS_TEXT("BEGIN_BRACKET_BLOCK");
    case END_BRACKET_BLOCK:
        return OS_TEXT("END_BRACKET_BLOCK");

    case BEGIN_ARRAY_BLOCK:
        return OS_TEXT("BEGIN_ARRAY_BLOCK");
    case END_ARRAY_BLOCK:
        return OS_TEXT("END_ARRAY_BLOCK");

    case CODE_SEPARATOR:
        return OS_TEXT("CODE_SEPARATOR");
    case PARAM_SEPARATOR:
        return OS_TEXT("PARAM_SEPARATOR");

    case COMMENT_LINE:
        return OS_TEXT("COMMENT_LINE");
    case COMMENT_MULTI_LINE:
        return OS_TEXT("COMMENT_MULTI_LINE");

    case NAME:
        return OS_TEXT("NAME");
    case STRING:
        return OS_TEXT("STRING");

    case NUMBER:
        return OS_TEXT("NUMBER");

    case OPERATOR:
        return OS_TEXT("OPERATOR");
    case BINARY_OPERATOR:
        return OS_TEXT("BINARY_OPERATOR");

    case OPERATOR_INDIRECT:
        return OS_TEXT("OPERATOR_INDIRECT");
    case OPERATOR_CONCAT:
        return OS_TEXT("OPERATOR_CONCAT");
    case BEFORE_INJECT_VAR:
        return OS_TEXT("BEFORE_INJECT_VAR");
    case AFTER_INJECT_VAR:
        return OS_TEXT("AFTER_INJECT_VAR");

    case OPERATOR_THIS:
        return OS_TEXT("OPERATOR_THIS");
    case OPERATOR_LOGIC_AND:
        return OS_TEXT("OPERATOR_LOGIC_AND");
    case OPERATOR_LOGIC_OR:
        return OS_TEXT("OPERATOR_LOGIC_OR");
    case OPERATOR_LOGIC_PTR_EQ:
        return OS_TEXT("OPERATOR_LOGIC_PTR_EQ");
    case OPERATOR_LOGIC_PTR_NE:
        return OS_TEXT("OPERATOR_LOGIC_PTR_NE");
    case OPERATOR_LOGIC_EQ:
        return OS_TEXT("OPERATOR_LOGIC_EQ");
    case OPERATOR_LOGIC_NE:
        return OS_TEXT("OPERATOR_LOGIC_NE");
    case OPERATOR_LOGIC_GE:
        return OS_TEXT("OPERATOR_LOGIC_GE");
    case OPERATOR_LOGIC_LE:
        return OS_TEXT("OPERATOR_LOGIC_LE");
    case OPERATOR_LOGIC_GREATER:
        return OS_TEXT("OPERATOR_LOGIC_GREATER");
    case OPERATOR_LOGIC_LESS:
        return OS_TEXT("OPERATOR_LOGIC_LESS");
    case OPERATOR_LOGIC_NOT:
        return OS_TEXT("OPERATOR_LOGIC_NOT");

    case OPERATOR_INC:
        return OS_TEXT("OPERATOR_INC");
    case OPERATOR_DEC:
        return OS_TEXT("OPERATOR_DEC");

    case OPERATOR_QUESTION:
        return OS_TEXT("OPERATOR_QUESTION");
    case OPERATOR_COLON:
        return OS_TEXT("OPERATOR_COLON");

    case OPERATOR_BIT_AND:
        return OS_TEXT("OPERATOR_BIT_AND");
    case OPERATOR_BIT_OR:
        return OS_TEXT("OPERATOR_BIT_OR");
    case OPERATOR_BIT_XOR:
        return OS_TEXT("OPERATOR_BIT_XOR");
    case OPERATOR_BIT_NOT:
        return OS_TEXT("OPERATOR_BIT_NOT");
    case OPERATOR_COMPARE:
        return OS_TEXT("OPERATOR_COMPARE");
    case OPERATOR_ADD:
        return OS_TEXT("OPERATOR_ADD");
    case OPERATOR_SUB:
        return OS_TEXT("OPERATOR_SUB");
    case OPERATOR_MUL:
        return OS_TEXT("OPERATOR_MUL");
    case OPERATOR_DIV:
        return OS_TEXT("OPERATOR_DIV");
    case OPERATOR_MOD:
        return OS_TEXT("OPERATOR_MOD");
    case OPERATOR_LSHIFT:
        return OS_TEXT("OPERATOR_LSHIFT");
    case OPERATOR_RSHIFT:
        return OS_TEXT("OPERATOR_RSHIFT");
    case OPERATOR_POW:
        return OS_TEXT("OPERATOR_POW");

    case OPERATOR_BIT_AND_ASSIGN:
        return OS_TEXT("OPERATOR_BIT_AND_ASSIGN");
    case OPERATOR_BIT_OR_ASSIGN:
        return OS_TEXT("OPERATOR_BIT_OR_ASSIGN");
    case OPERATOR_BIT_XOR_ASSIGN:
        return OS_TEXT("OPERATOR_BIT_XOR_ASSIGN");
    case OPERATOR_BIT_NOT_ASSIGN:
        return OS_TEXT("OPERATOR_BIT_NOT_ASSIGN");
    case OPERATOR_ADD_ASSIGN:
        return OS_TEXT("OPERATOR_ADD_ASSIGN");
    case OPERATOR_SUB_ASSIGN:
        return OS_TEXT("OPERATOR_SUB_ASSIGN");
    case OPERATOR_MUL_ASSIGN:
        return OS_TEXT("OPERATOR_MUL_ASSIGN");
    case OPERATOR_DIV_ASSIGN:
        return OS_TEXT("OPERATOR_DIV_ASSIGN");
    case OPERATOR_MOD_ASSIGN:
        return OS_TEXT("OPERATOR_MOD_ASSIGN");
    case OPERATOR_LSHIFT_ASSIGN:
        return OS_TEXT("OPERATOR_LSHIFT_ASSIGN");
    case OPERATOR_RSHIFT_ASSIGN:
        return OS_TEXT("OPERATOR_RSHIFT_ASSIGN");
    case OPERATOR_POW_ASSIGN:
        return OS_TEXT("OPERATOR_POW_ASSIGN");

    case OPERATOR_ASSIGN:
        return OS_TEXT("OPERATOR_ASSIGN");

    case OPERATOR_RESERVED:
        return OS_TEXT("OPERATOR_RESERVED");

    case OPERATOR_END:
        return OS_TEXT("OPERATOR_END");

    case ERROR_TOKEN:
        return OS_TEXT("ERROR_TOKEN");
    }
...
int OS::Core::Compiler::cacheString(Table * strings_table, Vector<String>& strings, const String& str)
{
    ...
    if(prop)
    {
        ...
        int i;
        OS_NUMBER_TO_INT(i, OS_VALUE_NUMBER(prop->value));
        return i;
    }
    ...
    if(recent_token->type == Tokenizer::NAME && (exp->type == EXP_TYPE_PARAMS || exp->type == EXP_TYPE_NEW_LOCAL_VAR || exp->type == EXP_TYPE_NAME))
    {
        ...
        */
        list.add(loop_scope OS_DBG_FILEPOS);
        {
            ...
            loop_scope->list.add(exp OS_DBG_FILEPOS);
            exp = NULL;
        }
...
bool OS::Core::Compiler::saveToStream(StreamWriter * writer)
{
    ...
    for(i = 0; i < prog_numbers.count; i++)
    {
        ...
        {
            int_count++;
            int_stream.writeUVariable(i - int_index);
            int_index = i;
        ...
        {
            float_count++;
            float_stream.writeUVariable(i - float_index);
            float_index = i;
        ...
        {
            double_count++;
            double_stream.writeUVariable(i - double_index);
            double_index = i;
            double_stream.writeDouble((double)val);
            continue;
        }
        long_double_count++;
        long_double_stream.writeUVariable(i - long_double_index);
        long_double_index = i;
...
OS::Core::OpcodeType OS::Core::Program::getOpcodeType(Compiler::ExpressionType exp_type, Compiler::ECompiledValueType value_type)
{
    ...
    switch(exp_type)
    {
    case Compiler::EXP_TYPE_CALL:
        return OP_CALL;
    case Compiler::EXP_TYPE_CALL_AUTO_PARAM:
        return OP_CALL;
    case Compiler::EXP_TYPE_CALL_METHOD:
        return OP_CALL_METHOD;
#ifdef OS_TAIL_CALL_ENABLED
    case Compiler::EXP_TYPE_TAIL_CALL:
        return OP_TAIL_CALL;
    case Compiler::EXP_TYPE_TAIL_CALL_METHOD:
        return OP_TAIL_CALL_METHOD;
#endif
    case Compiler::EXP_TYPE_SUPER_CALL:
        return OP_SUPER_CALL;
        // case Compiler::EXP_TYPE_SUPER: return OP_SUPER;
    case Compiler::EXP_TYPE_INIT_ITER:
        return OP_INIT_ITER;

    case Compiler::EXP_TYPE_GET_PROPERTY:
        return OP_GET_PROPERTY;
    case Compiler::EXP_TYPE_SET_PROPERTY:
        return OP_SET_PROPERTY;
    case Compiler::EXP_TYPE_INIT_PROPERTY:
        return OP_INIT_PROPERTY;
    case Compiler::EXP_TYPE_SET_PROPERTY_NO_POP:
        return OP_SET_PROPERTY;

    case Compiler::EXP_TYPE_GET_UPVALUE:
        return OP_GET_UPVALUE;
    case Compiler::EXP_TYPE_SET_UPVALUE:
        return OP_SET_UPVALUE;

    case Compiler::EXP_TYPE_MOVE:
        return OP_MOVE;
    case Compiler::EXP_TYPE_RETURN:
        return OP_RETURN;

    case Compiler::EXP_TYPE_BIT_NOT:
        return OP_BIT_NOT;
    case Compiler::EXP_TYPE_PLUS:
        return OP_PLUS;
    case Compiler::EXP_TYPE_MINUS:
        return OP_MINUS;

    case Compiler::EXP_TYPE_BIT_AND:
        return Lib::get(value_type, OP_NUMBER_BIT_AND, OP_BIT_AND);
    case Compiler::EXP_TYPE_BIT_OR:
        return Lib::get(value_type, OP_NUMBER_BIT_OR, OP_BIT_OR);
    case Compiler::EXP_TYPE_BIT_XOR:
        return Lib::get(value_type, OP_NUMBER_BIT_XOR, OP_BIT_XOR);

    case Compiler::EXP_TYPE_COMPARE:
        return Lib::get(value_type, OP_NUMBER_SUB, OP_COMPARE);
    case Compiler::EXP_TYPE_ADD:
        return Lib::get(value_type, OP_NUMBER_ADD, OP_ADD);
    case Compiler::EXP_TYPE_SUB:
        return Lib::get(value_type, OP_NUMBER_SUB, OP_SUB);
    case Compiler::EXP_TYPE_MUL:
        return Lib::get(value_type, OP_NUMBER_MUL, OP_MUL);
    case Compiler::EXP_TYPE_DIV:
        return Lib::get(value_type, OP_NUMBER_DIV, OP_DIV);
    case Compiler::EXP_TYPE_MOD:
        return Lib::get(value_type, OP_NUMBER_MOD, OP_MOD);
    case Compiler::EXP_TYPE_LSHIFT:
        return Lib::get(value_type, OP_NUMBER_LSHIFT, OP_LSHIFT);
    case Compiler::EXP_TYPE_RSHIFT:
        return Lib::get(value_type, OP_NUMBER_RSHIFT, OP_RSHIFT);
    case Compiler::EXP_TYPE_POW:
        return Lib::get(value_type, OP_NUMBER_POW, OP_POW);
    }
    OS_ASSERT(false);
    return OP_ADD;
}
...
int OS::Core::getValueHash(const Value& index)
{
    ...
    case OS_VALUE_TYPE_NUMBER:
    {
        ...
        int i;
        OS_NUMBER_TO_INT(i, OS_VALUE_NUMBER(index));
        return i;
...
void OS::Core::deleteValueProperty(GCValue * table_value, Value index, bool del_enabled, bool prototype_enabled)
{
    if(table_value->type == OS_VALUE_TYPE_ARRAY && OS_IS_VALUE_NUMBER(index))
    {
        ...
        int i;
        OS_NUMBER_TO_INT(i, OS_VALUE_NUMBER(index)); // = (int)valueToInt(index);
...
OS::Core::GCFunctionValue * OS::Core::pushFunctionValue(StackFunction * stack_func, Program * prog, FunctionDecl * func_decl, Value env)
{
...
OS::Core::GCStringValue * OS::Core::GCStringValue::allocAndPush(OS * allocator, int p_hash, const void * buf1, int len1, const void * buf2, int len2 OS_DBG_FILEPOS_DECL)
{
    ...
    // string->prototype->ref_count++;
    OS_BYTE * data_buf = string->toBytes();
    OS_MEMCPY(data_buf, buf1, len1);
    data_buf += len1;
    if(len2)
    {
        OS_MEMCPY(data_buf, buf2, len2);
        data_buf += len2;
    }
...
bool OS::Core::init()
{
    ...
    for(i = 0; i < PROTOTYPE_COUNT; i++)
    {
        retainValue(prototypes[i] = pushObjectValue(NULL));
        pop();
    }
    // retainValue(check_recursion = pushObjectValue()); pop();
    retainValue(global_vars = pushObjectValue());
    pop();
    retainValue(user_pool = pushObjectValue());
    pop();
    retainValue(retain_pool = pushObjectValue());
    pop();
    retainValue(check_get_recursion = pushObjectValue());
    pop();
    retainValue(check_set_recursion = pushObjectValue());
    pop();
    retainValue(check_valueof_recursion = pushObjectValue());
    pop();
...
template <> struct CtypeName<OS::Core::Buffer>
{
    static const OS_CHAR * getName()
    {
        return OS_TEXT("Buffer");
    }
};
...
template <> struct CtypeName<OS::Core::File>
{
    static const OS_CHAR * getName()
    {
        return OS_TEXT("File");
...
void OS::Core::call(int start_pos, int call_params, int ret_values, GCValue * self_for_proto, bool allow_only_enter_func, OS_ECallType call_type)
{
    ...
    case OS_VALUE_TYPE_FUNCTION:
    {
        ...
        if(call_params > func_decl->num_params)
        {
            ...
            retainValue(rest_arguments = pushArrayValue(num_extra_params));
            pop();
...
void OS::require(const String& filename, bool required, int ret_values, OS_ESourceCodeType source_code_type, bool check_utf8_bom, bool handle_exception)
{
    ...
    g_log<<filename.toChar()<<std::endl;
    g_log.flush();
...
recurse:
    ...
    else
    {
        ...
        for (;;)
        {
            ...
            while (l <= hi && comp(this, l, lo, user_params) <= 0);
            do
            {
                h -= width;
            }
            while (h > lo && comp(this, h, lo, user_params) >= 0);
            if (h < l) break;
            qsortSwap(l, h, width);
        }
...
{
    ~FunctionDataFinalizer()
    {
        ObjectScript::finalizeAllBinds();
    }
